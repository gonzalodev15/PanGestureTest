...
class DigimonViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        getDigimon()
        initCards(card: card1)
        initCards(card: card2)
        initCards(card: card3)
        initCards(card: card4)
        
        initImages(card: pictureImageView1)
        initImages(card: pictureImageView2)
        initImages(card: pictureImageView3)
        initImages(card: pictureImageView4)
    }
    
    func initCards(card: UIView){
        card.layer.cornerRadius = 10
    }
    
    func initImages(card: UIImageView){
